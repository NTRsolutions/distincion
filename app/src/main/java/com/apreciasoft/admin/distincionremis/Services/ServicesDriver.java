package com.apreciasoft.admin.distincionremis.Services;

import com.apreciasoft.admin.distincionremis.Entity.Company;
import com.apreciasoft.admin.distincionremis.Entity.DriverCurrentAcountEntity;
import com.apreciasoft.admin.distincionremis.Entity.DriverFull;
import com.apreciasoft.admin.distincionremis.Entity.InfoTravelEntity;
import com.apreciasoft.admin.distincionremis.Entity.RequetClient;
import com.apreciasoft.admin.distincionremis.Entity.acountCompany;
import com.apreciasoft.admin.distincionremis.Entity.costCenterCompany;
import com.apreciasoft.admin.distincionremis.Entity.dataAddPlusDriverEntity;
import com.apreciasoft.admin.distincionremis.Entity.driver;
import com.apreciasoft.admin.distincionremis.Entity.fleetType;
import com.apreciasoft.admin.distincionremis.Entity.modelEntity;
import com.apreciasoft.admin.distincionremis.Entity.resp;
import com.apreciasoft.admin.distincionremis.Entity.responseFilterVehicle;
